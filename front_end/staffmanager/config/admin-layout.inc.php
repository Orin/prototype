<body>
  <div id="page-wrapper">
	...
	elseif ($page == 'genReport'      		&& ($level <=2)) 	{?><div id="<?php echo $page; ?>"><?php include 'pages/genReport.php'; ?></div><?php }
	...
	elseif ($page == 'editTA'      	&& ($level <=2)) 	{?><div id="<?php echo $page; ?>"><?php include 'pages/editTA.php'; ?></div><?php }
